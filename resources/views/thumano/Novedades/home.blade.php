                ...
                <div class="panel-body">
                    ...
                    <table class="table " style="margin-top: 30px">
                        ...
                        <tbody>
                            ...
                            <td style="text-align: center;"><a title="Ver Elemento" href="{{route('formulario_Novedade',['id'=>$Novedade->id, 'ruta'=>'ver'])}}" class="btn btn-xs btn-success"><i class="glyphicon glyphicon-eye-open"></i></a></td>
                            <td style="text-align: center;"><a title="Editar Elemento" href="{{route('formulario_Novedade',['id'=>$Novedade->id, 'ruta'=>'actualizar'])}}" class="btn btn-xs btn-info"><i class="glyphicon glyphicon-edit"></i></a></td>
                            <td style="text-align: center;">
                                <form action="{{route('delete_Novedade',['id'=>$Novedade->id])}}" method="POST">
...
<script >
    ...
    $("input#pdf_export").on("click", function(e){
           ...
           $("#reporte").val("PDF");
   $('#form_busquedad').attr('action', "{{route('Report_Novedade')}}");
