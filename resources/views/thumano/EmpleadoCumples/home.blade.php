            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <table class="table " style="margin-top: 30px">
                        ...
                        <tbody>
                            @foreach ($EmpleadoCumples as $EmpleadoCumple)
                            <tr>
                            <td>{{$loop->iteration}}</td>
                            <td>{{$EmpleadoCumple->empleado->nombres}}  {{$EmpleadoCumple->empleado->apellidos}}</td>

                             <td>{{$EmpleadoCumple->fecha_desde}}</td>
                            <td style="text-align: center;"><a title="Ver Elemento" href="{{route('formulario_EmpleadoCumple',['id'=>$EmpleadoCumple->id, 'ruta'=>'ver'])}}" class="btn btn-xs btn-success"><i class="glyphicon glyphicon-eye-open"></i></a></td>
                            </tr>
                        @endforeach
