            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <table class="table " style="margin-top: 30px">
                        ...
                        <tbody>
                            @foreach ($DocumentoFinalizas as $DocumentoFinaliza)
                            <tr>
                            <td>{{$loop->iteration}}</td>
                            <td>{{$DocumentoFinaliza->empleado->nombres}}  {{$DocumentoFinaliza->empleado->apellidos}}</td>

                             <td>{{$DocumentoFinaliza->fecha_desde}}</td>
                            <td style="text-align: center;"><a title="Ver Elemento" href="{{route('formulario_DocumentoFinaliza',['id'=>$DocumentoFinaliza->id, 'ruta'=>'ver'])}}" class="btn btn-xs btn-success"><i class="glyphicon glyphicon-eye-open"></i></a></td>
                            </tr>
                        @endforeach
