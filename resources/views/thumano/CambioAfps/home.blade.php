        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-heading">
                    ...
                    <a class="btn btn-info" href="{{route('formulario_CambioAfp',['id'=>0, 'ruta'=>'crear'])}}"><i class="glyphicon glyphicon-plus"></i></a>
                    </div>
                ...
                <div class="panel-body">
                    ...
                    <table class="table " style="margin-top: 30px">
                        ...
                        <tbody>
                            @foreach ($CambioAfps as $CambioAfp)
                            <tr>
                            <td>{{$loop->iteration}}</td>
                            <td>{{$CambioAfp->empleado->nombres}}  {{$CambioAfp->empleado->apellidos}}</td>

                             <td>{{$CambioAfp->fecha_desde}}</td>
                            <td style="text-align: center;"><a title="Ver Elemento" href="{{route('formulario_CambioAfp',['id'=>$CambioAfp->id, 'ruta'=>'ver'])}}" class="btn btn-xs btn-success"><i class="glyphicon glyphicon-eye-open"></i></a></td>
                            <td style="text-align: center;"><a title="Editar Elemento" href="{{route('formulario_CambioAfp',['id'=>$CambioAfp->id, 'ruta'=>'actualizar'])}}" class="btn btn-xs btn-info"><i class="glyphicon glyphicon-edit"></i></a></td>
                            <td style="text-align: center;">
                                <form action="{{route('delete_CambioAfp',['id'=>$CambioAfp->id])}}" method="POST">
