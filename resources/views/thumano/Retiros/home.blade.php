            ...
            <div class="panel panel-default">
                ...
                <div class="panel-heading">
                    <div style="display: inline-block;">
                        @if($sede)
                    <a class="btn btn-info" href="{{route('formulario_Retiro',['id'=>0, 'ruta'=>'crear',"sede"=>"Sede"])}}"><i class="glyphicon glyphicon-plus"></i></a>    
                        @else
                    <a class="btn btn-info" href="{{route('formulario_Retiro',['id'=>0, 'ruta'=>'crear'])}}"><i class="glyphicon glyphicon-plus"></i></a>
                        @endif
                    </div>
                ...
                <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6" style="padding: 0 20px 0 20px">
                                ...
                                <div style="display: none">
                                    @if($sede)
                                    <a class="btn btn-info col-sm-3" href="{{url('All_Retiro',['sede'=>'Sede'])}}" value="Borrar filtros">Borrar Filtro</a>
                                    @else
                                <a class="btn btn-info col-sm-3" href="{{url('All_Retiro')}}" value="Borrar filtros">Borrar Filtro</a>    
                                    @endif
                    ...
                    <table class="table " style="margin-top: 30px">
                        ...
                        <tbody>
                            ...
                            <td>{{$Retiro->empleado->nombres}}  {{$Retiro->empleado->apellidos}}</td>

                             <td>{{$Retiro->fecha_desde}}</td>

                            
                            <td style="text-align: center;"><a title="Ver Elemento" href="{{route('formulario_Retiro',['id'=>$Retiro->id, 'ruta'=>'ver'])}}" class="btn btn-xs btn-success"><i class="glyphicon glyphicon-eye-open"></i></a></td>
                            <td style="text-align: center;"><a title="Editar Elemento" href="{{route('formulario_Retiro',['id'=>$Retiro->id, 'ruta'=>'actualizar'])}}" class="btn btn-xs btn-info"><i class="glyphicon glyphicon-edit"></i></a></td>
                            <td style="text-align: center;">
                                <form action="{{route('delete_Retiro',['id'=>$Retiro->id])}}" method="POST">
