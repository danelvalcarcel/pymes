                ...
                <div class="panel-body">
                    ...
                    <table class="table " style="margin-top: 30px">
                        ...
                        <tbody>
                            ...
                            @if($sede)
                            <td style="text-align: center;"><a title="Editar Elemento" href="{{route('formulario_Vacacione',['id'=>$Vacacione->id, 'ruta'=>'actualizar','sede'=>'Sede'])}}" class="btn btn-xs btn-info"><i class="glyphicon glyphicon-edit"></i></a></td>
                                        @else
