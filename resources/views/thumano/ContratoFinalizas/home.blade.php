            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <table class="table " style="margin-top: 30px">
                        ...
                        <tbody>
                            @foreach ($ContratoFinalizas as $ContratoFinaliza)
                            <tr>
                            <td>{{$loop->iteration}}</td>
                            <td>{{$ContratoFinaliza->empleado->nombres}}  {{$ContratoFinaliza->empleado->apellidos}}</td>

                             <td>{{$ContratoFinaliza->fecha_desde}}</td>
                            <td style="text-align: center;"><a title="Ver Elemento" href="{{route('formulario_ContratoFinaliza',['id'=>$ContratoFinaliza->id, 'ruta'=>'ver'])}}" class="btn btn-xs btn-success"><i class="glyphicon glyphicon-eye-open"></i></a></td>
                            </tr>
                        @endforeach
