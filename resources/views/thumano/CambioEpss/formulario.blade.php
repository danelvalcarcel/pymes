    ...
    <div class="main-content-inner">
        <div class="col-md-12">
            ...
            <form id="form_sueldo" enctype="multipart/form-data" action="{{ route($ruta)}}" method="post">
                ...
                <div class="col-md-12" style="margin-top: 20px">
                            <div class="col-md-4">
                            <label for="ideps"  class="col-md-4 form-control" style="border:none">Nueva Eps</label>
                             </div>

                            <div class="col-md-6">
                                <select  id="ideps" class="form-control" name="ideps" >
                                    <option value="0">Selecciona una opcion</option>}
                                    option
                ...
                @endif
                    ...
                    <div class="col-sm-12" style="padding-top: 30px">
                                        ...
                                        <div class="col-sm-6">
                                        <a href="{{route('All_CambioEps')}}" class="btn col-md-10 btn-warning col-md-offset-1 "  >
                                        Volver a Inicio
                                        </a>
                                        </div>
                                       @elseif($ruta =="CambioEps_create" )
                                       <div class="col-sm-6">
                                        ...
                                        <div class="col-sm-6">
                                        <a href="{{route('All_CambioEps')}}" class="btn btn-warning col-md-10 col-md-offset-1 "  >
                                       Volver a Inicio
                                        </a>
                                        </div>
                                       @else
