                ...
                <div class="panel-body">
                    ...
                    <table class="table " style="margin-top: 30px">
                        ...
                        <tbody>
                            ...
                            <td>{{$tipos_nomina->nombre}}</td>
                            <td style="text-align: center;"><a href="{{route('formulario_tipos_nomina',['id'=>$tipos_nomina->idtiponomina, 'ruta'=>'ver'])}}" class="btn btn-success"><i class="glyphicon glyphicon-eye-open"></i></a></td>
                            <td style="text-align: center;"><a href="{{route('formulario_tipos_nomina',['id'=>$tipos_nomina->idtiponomina, 'ruta'=>'actualizar'])}}" class="btn btn-info"><i class="glyphicon glyphicon-edit"></i></a></td>
