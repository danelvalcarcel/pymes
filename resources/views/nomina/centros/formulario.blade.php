            ...
            <form action="{{ route($ruta)}}" method="post">
                ...
                <div class="col-md-12" style="margin-top: 15px" >
                    ...
                    <div class="col-sm-12" style="padding-top: 30px">
                                         @if($ruta =="centros_trabajo_update" )
                                         <div class="col-sm-6">
                                        ...
                                        <div class="col-sm-6">
                                        <a href="{{route('All_centros_trabajo')}}" class="btn col-md-10 btn-warning col-md-offset-1 "  >
                                        Volver a Inicio
                                        </a>
                                        </div>
                                       @elseif($ruta =="centros_trabajo_create" )
                                       <div class="col-sm-6">
                                        ...
                                        <div class="col-sm-6">
                                        <a href="{{route('All_centros_trabajo')}}" class="btn btn-warning col-md-10 col-md-offset-1 "  >
                                       Volver a Inicio
                                        </a>
                                        </div>
                                       @else
