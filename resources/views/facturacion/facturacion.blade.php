                        ...
                        <div class="row" style="margin-top: 10px">
                            <div class="col-md-9">
                                <div class="panel panel-primary">
                                    ...
                                    <div class="panel-body" style="background: #2d2d2d">
                                        <table  style="background: #2d2d2d" id="factura_deta" class="table">
                            ...
                            <div class="panel panel-success">
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <h5><strong>$ </strong><strong id="base_factura">0.00</strong></h5>
                                        </div>
                                        <div class="col-md-4">
                                            <h5>Impuesto</h5>
                                        </div>
                                        <div class="col-md-8">
                                            <h5><strong>$ </strong><strong id="impuesto_factura">0.00</strong></h5>
                                        </div>
                                        <div class="col-md-4">
                                            <h5>Total</h5>
                                        </div>
                                        <div class="col-md-8">
                                            <h5><strong>$ </strong><strong id="total_factura">0.00</strong></h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        $(document).on("ready", function (e) {
            ...
            $("#cont_prod_busc_row").on("click","#btn_agregar_prod_conse", function (e) {
                ...
                $("#factura_deta>tbody").append("<tr data-id_inv='"+$("#codigo_"+producto+"").attr("data-id_inv")+"' id='"+$("#codigo_"+producto+"").text()+"'>" +
                    ...
                    "<ul class='dropdown-menu' aria-labelledby='dropdownMenu1' style='background: #2d2d2d'>"+
            ...
            $("#btn_agregar_caja").on("click",function(e) {
                ...
                $("#tabla_caja>tbody").append("<tr  data-tipo_pago='"+tipo_pago+"' id='"+caja+tipo_pago+"' data-caja ='"+caja+"'><td data-caja ='"+caja+"'>"+caja_text+"</td><td data-tipo_pago ='"+tipo_pago+"'>"+tipo_pago_text+" </td><td id='dinero_asig_caja' data-dinero='"+dinero+"'>"+number_format_coma(dinero)+"</td><td id='porciento_caja'>"+porciento+"%</td>" +
                    ...
                    " aria-hidden='true'></span>" +
                    "<ul class='dropdown-menu' aria-labelledby='dropdownMenu1' style='background: #2d2d2d'>"+
                    "<li><a id='eliminar_caja' style='color:#fff' href='"+caja+tipo_pago+"'>Eliminar</a></li>"+
                    "</ul>  </div>"+
                    "</td></tr>");
                var progreso =(total_dinero_asignado/total)*100 +"%";
                $("div#progreso").css("width", progreso);
