              ...
              <div class="col-md-12" style="margin-top: 20px">
                            ...
                            <div class="col-md-6">
                                <select required  id="tipo" class="form-control" name="tipo" >
                                    <option value="0">SubCuenta</option>
                 ...
                 <div class="col-md-12" style="margin-top: 20px">
                            <div class="col-md-4">
                            <label for="manejatercero"  class="col-md-4 form-control" style="border:none">Maneja Tercero</label>
                             </div>

                            <div class="col-md-6">
                                <select required  id="manejatercero" class="form-control" name="manejatercero" >
                 ...
                 <div class="col-md-12" style="margin-top: 20px">
                            <div class="col-md-4">
                            <label for="corriente"  class="col-md-4 form-control" style="border:none">Corriente</label>
                             </div>

                            <div class="col-md-6">
                                <select required  id="corriente" class="form-control" name="corriente" >
                                    <option value="1">Si</option>
                                    <option value="0">No</option>
                                </select>
                            </div>
                    ...
                    <div class="col-sm-12" style="padding-top: 30px">
                                        ...
                                        <div class="col-sm-6">
                                        <a href="{{route('All_Puc')}}" class="btn col-md-10 btn-warning col-md-offset-1 "  >
                                        Volver a Inicio
                                        </a>
                                        </div>
                                       @elseif($ruta =="Puc_create" )
                                       <div class="col-sm-6">
                                        ...
                                        <div class="col-sm-6">
                                        <a href="{{route('All_Puc')}}" class="btn btn-warning col-md-10 col-md-offset-1 "  >
                                       Volver a Inicio
                                        </a>
                                        </div>
                                       @else
