            ...
            <form id="form_sueldo" enctype="multipart/form-data" action="{{ route($ruta)}}" method="post">
                ...
                <div class="col-md-12" style="margin-top: 15px" >
                    ...
                    <div class="col-sm-12" style="padding-top: 30px">
                                         @if($ruta =="CajaCompensacion_update" )
                                         <div class="col-sm-6">
                                        ...
                                        <div class="col-sm-6">
                                        <a href="{{route('All_CajaCompensacion')}}" class="btn col-md-10 btn-warning col-md-offset-1 "  >
                                        Volver a Inicio
                                        </a>
                                        </div>
                                       @elseif($ruta =="CajaCompensacion_create" )
                                       <div class="col-sm-6">
                                        ...
                                        <div class="col-sm-6">
                                        <a href="{{route('All_CajaCompensacion')}}" class="btn btn-warning col-md-10 col-md-offset-1 "  >
                                       Volver a Inicio
                                        </a>
                                        </div>
                                       @else
