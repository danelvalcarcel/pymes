        ...
        <div class="col-md-12">
            ...
            <form id="form_sueldo" enctype="multipart/form-data" action="{{ route($ruta)}}" method="post">
                ...
                <div class="col-md-12" style="margin-top: 15px" >
                    ...
                    <div class="col-md-6">
                        <input required class="form-control" id="nit" type="text" name="nit" value="{{$elemento->nit}}" >
                    </div>
                </div>
                ...
                <div class="col-md-12" style="margin-top: 15px" >
                    ...
                    <div class="col-sm-12" style="padding-top: 30px">
                                        ...
                                        <div class="col-sm-6">
                                        <a href="{{route('All_Epp')}}" class="btn col-md-10 btn-warning col-md-offset-1 "  >
                                        Volver a Inicio
                                        </a>
                                        </div>
                                       @elseif($ruta =="Epp_create" )
                                       <div class="col-sm-6">
                                        ...
                                        <div class="col-sm-6">
                                        <a href="{{route('All_Epp')}}" class="btn btn-warning col-md-10 col-md-offset-1 "  >
                                       Volver a Inicio
                                        </a>
                                        </div>
                                       @else
