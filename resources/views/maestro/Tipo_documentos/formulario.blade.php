        ...
        <div class="col-md-12">
            ...
            <form id="form_sueldo" enctype="multipart/form-data" action="{{ route($ruta)}}" method="post">
                ...
                <div class="col-md-12" style="margin-top: 20px">
                            <div class="col-md-4">
                            <label for="expira"  class="col-md-4 form-control" style="border:none">Expira?</label>
                             </div>

                            <div class="col-md-6">
                                <select required  id="expira" class="form-control" name="expira" >
                    ...
                    <div class="col-sm-12" style="padding-top: 30px">
                                        ...
                                        <div class="col-sm-6">
                                        <a href="{{route('All_Tipo_documento')}}" class="btn col-md-10 btn-warning col-md-offset-1 "  >
                                        Volver a Inicio
                                        </a>
                                        </div>
                                       @elseif($ruta =="Tipo_documento_create" )
                                       <div class="col-sm-6">
                                        ...
                                        <div class="col-sm-6">
                                        <a href="{{route('All_Tipo_documento')}}" class="btn btn-warning col-md-10 col-md-offset-1 "  >
                                       Volver a Inicio
                                        </a>
                                        </div>
                                       @else
