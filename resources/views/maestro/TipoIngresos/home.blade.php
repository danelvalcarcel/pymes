        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-heading">
                    ...
                    <a class="btn btn-info" href="{{route('formulario_TipoIngreso',['id'=>0, 'ruta'=>'crear'])}}"><i class="glyphicon glyphicon-plus"></i></a>
                    </div>
                ...
                <div class="panel-body">
                    ...
                    <table class="table " style="margin-top: 30px">
                        ...
                        <tbody>
                            ...
                            <td style="text-align: center;"><a title="Ver Elemento" href="{{route('formulario_TipoIngreso',['id'=>$TipoIngreso->idtipoingreso, 'ruta'=>'ver'])}}" class="btn btn-xs btn-success"><i class="glyphicon glyphicon-eye-open"></i></a></td>
                            <td style="text-align: center;"><a title="Editar Elemento" href="{{route('formulario_TipoIngreso',['id'=>$TipoIngreso->idtipoingreso, 'ruta'=>'actualizar'])}}" class="btn btn-xs btn-info"><i class="glyphicon glyphicon-edit"></i></a></td>
                            <td style="text-align: center;">
                                <form action="{{route('delete_TipoIngreso',['id'=>$TipoIngreso->idtipoingreso])}}" method="POST">
