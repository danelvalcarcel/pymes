                              ...
                              <div style="padding-left:17px" class=" dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                               ...
                               <div style="display:inline-block; margin-left:14px; font-size:16px" class="texto_menu">Mantenimiento</div>
                                ...
                                <ul id="desplegable1" class="dropdown-menu">
                                  ...
                                  <li><a tabindex="-1" href="/contratacion/tipos_contratos">Tipos de Nomina</a></li>

                                  <li><a tabindex="-1" href="/contratacion/all_criterios_evaluacion">Centros de Trabajo</a></li>

                                  <li><a tabindex="-1" href="/contratacion/articulos_servicios">Cargos</a></li>
                              ...
                              <div style="padding-left:17px" class=" dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                               ...
                               <div style="display:none; margin-left:14px; font-size:16px" class="texto_menu">Novedades</div>
                                ...
                                <ul id="desplegable1" class="dropdown-menu">
                                  ...
                                  <li><a tabindex="-1" href="/contratacion/comite_seguimiento">Retiro de Empleados</a></li>
                                  <li><a tabindex="-1" href="{{route('All_Incapacidade')}}">Incapacidades</a></li>
                                  <li><a tabindex="-1" href="/contratacion/licitaciones">Licencias</a></li>
                                  <li><a tabindex="-1" href="/contratacion/licitaciones">Vacaciones</a></li>
                                  <li><a tabindex="-1" href="/contratacion/oferentes">Novedades Hoja de Vida</a></li>
                                  <li><a tabindex="-1" href="/contratacion/contratos">Eventos</a></li>
                                  <li><a tabindex="-1" href="/contratacion/contratos">Cambio Eps</a></li>
                                  <li><a tabindex="-1" href="/contratacion/contratos">Cambio Epp</a></li>
                                </ul>
