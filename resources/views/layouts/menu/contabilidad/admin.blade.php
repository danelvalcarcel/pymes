          ...
          <li class="active">
            ...
            <b class="arrow"></b>
                              ...
                              <div style="padding-left:17px" class=" dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                               ...
                               <div style="display:inline-block; margin-left:14px; font-size:16px" class="texto_menu">Movimientos</div>

                              </div>

                                <ul id="desplegable1" class="dropdown-menu">
                                
                                   <li><a tabindex="-1" href="/contratacion/tipos_contratos">Iniciales</a></li>

                                  <li><a tabindex="-1" href="/contratacion/tipos_contratos">Por Documento</a></li>

                                  <li><a tabindex="-1" href="/contratacion/all_criterios_evaluacion">Por Comprobante</a></li>

                                  <li><a tabindex="-1" href="/contratacion/articulos_servicios">Por Cuenta</a></li>
                              ...
                              <div style="padding-left:17px" class=" dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                               ...
                               <div style="display:none; margin-left:14px; font-size:16px" class="texto_menu">Informes</div>
                                ...
                                <ul id="desplegable1" class="dropdown-menu">
                                  ...
                                  <li><a tabindex="-1" href="/contratacion/comite_seguimiento">Balance</a></li>

                                  <li><a tabindex="-1" href="/contratacion/precontratos">Balance por Terceros</a></li>
  ...
  <div style="padding-left:17px" class=" dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
   ...
   <div style="display:none; margin-left:14px; font-size:16px" class="texto_menu">Niif</div>
